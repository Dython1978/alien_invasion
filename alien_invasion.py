...
class AlienInvasion:
    ...
    def _update_bullets(self):
        """Обновляет позицииснарядов и уничтожает старые снаряды"""
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Удаление снарядови пришельцев учавствующих в коллизиях.
    ...
    def _update_screen(self):
        """Обновляет изображения на экране и отображает новый экраню"""
